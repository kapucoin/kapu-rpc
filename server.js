...
function startServer(port){
  if (program.allowRemote) console.log('Warning! kapu-rpc allows remote connections, this is potentially insecure!');
  ...
  server = restify.createServer().
    ...
    server.listen(port, function() {
      console.log('kapu-rpc listening at %s', server.url);
    });
}
